 ...
 */
function alignQuotaChannelId(channel, providerIds = [], preferredId = "") {
  if (!channel) return channel;
  const preferred = scalarText(preferredId, 160);
  if (preferred) return preferred === channel.id ? channel : { ...channel, id: preferred };
